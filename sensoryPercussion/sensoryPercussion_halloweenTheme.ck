// ============================================================
// HALLOWEEN THEME - melody/bass/chord triggered by drums
...
PulseOsc bassOsc => ADSR e1 => BiQuad f1 => PRCRev reverb1 => master;
.99 => f1.prad;
1 => f1.eqzs;
.05 => f1.gain;
0 => reverb1.mix;
...
SawOsc midMelOsc => ADSR e2 => BiQuad f2 => PRCRev reverb2 => master;
.99 => f2.prad;
1 => f2.eqzs;
.5 => f2.gain;
0 => reverb2.mix;
...
SawOsc melOsc => ADSR e3 => BiQuad f3 => PRCRev reverb3 => master;
.99 => f3.prad;
1 => f3.eqzs;
.9 => f3.gain;
0 => reverb3.mix;
