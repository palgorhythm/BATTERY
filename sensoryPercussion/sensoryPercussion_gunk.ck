// ============================================================
// GUNK - bass subdivisions with overtone soloing
...
SawOsc sin => SawOsc overdrive => ADSR e1 => PRCRev reverb1 => BiQuad f => master;
1 => overdrive.sync;
defaultGain * 6.0 => overdrive.gain;
.99 => f.prad;
1 => f.eqzs;
.03 => f.gain;
defaultGain * 6.0 => sin.gain;
0.05 => reverb1.mix;
...
SqrOsc osc3 => ADSR e3 => PRCRev reverb3 => master;
defaultGain => osc3.gain;
...
fun void ddrumTrig()
{
    while(true)
    {
        ...
        while(min.recv(msg))
        {
            ...
            else if(msg.data3!=0 && msg.data2 == 3) //floor tom (was tom1/2)
            {
            ...
            else if(msg.data3!=0 && msg.data2 == 9)
            {
            ...
            else if(msg.data3!=0 && msg.data2 == 10)
            {
            ...
            else if(msg.data3!=0 && msg.data2 == 11)
            {
            ...
            else if(msg.data3!=0 && msg.data2 == 12)
            {
            ...
            else if(msg.data3!=0 && msg.data2 == 13)
            {
            ...
            else if(msg.data3!=0 && msg.data2 == 14)
            {
