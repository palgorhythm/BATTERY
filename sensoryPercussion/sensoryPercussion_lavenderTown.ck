// ============================================================
// LAVENDER TOWN - Pokemon Lavender Town theme arrangement
...
SawOsc o1 => ADSR e1 => master;
SqrOsc o2 => ADSR e2 => master;
SqrOsc o3 => ADSR e3 => PRCRev reverb3 => master;
SawOsc o4 => ADSR e4 => PRCRev reverb4 => master;
...
fun void ddrumTrig()
{
    while(true)
    {
        ...
        while(min.recv(msg))
        {
            ...
            if(msg.data3!=0 && msg.data2 == 3 && hitTom==0) //floor tom (was tom1/2)
            {
